...
<!--    local用APIキー-->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8X0LS4MBefM3ZK7bD8xIX-ySGxrFndO0&callback=initMap" async defer></script>
<!--    本番用APIキー-->
<!--    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrZIvzj3PJIbODIABFlNjEkIYyhHRfTyM&callback=initMap" async defer></script>-->
    <form action="map_data.php" method="post" class="form">
